...
public class EmailConstant {
    ...
    public static final String USERNAME = "maheswaranm2k18@gamil.com";
    
//    @Value("${spring.mail.password}")
    public static final String PASSWORD = "wyvnwoeargiapxym";
    public static final String FROM_EMAIL = "maheswaranm2k18@gamil.com";
